...
int main(int argc, char *argv[]) {
  ...
  blockchain_node_init(&prev_blk_node, 1, 1, (unsigned char *)hash_buff,
                       (unsigned char *)"h!", sizeof("h!"));
  blockchain_node_hash(&prev_blk_node, ((unsigned char *)(&prev_blk_node.hash)),
                       blockchain_do_hash);

    blockchain_node_init(
            &blk_node, 1, 1, ((unsigned char *)(&prev_blk_node.hash)),
            (unsigned char *)"g124ood bye, world.YqwdAYAKIGKU", sizeof("g124ood bye, world.YqwdAYAKIGKU"));
    printf("Done.\n");
...
//        blk_t tmp = blk_node;
//        blockchain_node_init(
//                &blk_node, i+2, 1, ((unsigned char *)(&tmp.hash)),
//                (unsigned char *)"g124ood bye, world.YqwdAYAKIGKU", sizeof("g124ood bye, world.YqwdAYAKIGKU"));
//        printf("Done.\n");
//
//        printf("Mining a block with difficulty %d... ", diff);
...
//
//        printf("Testing if the block is good... ");
//        if (blockchain_node_verify(&blk_node, &tmp, blockchain_do_hash))
//            printf("Good.\n");
//        else {
//            printf("Not good.\n");
//            printf("Showing content of the nodes:\n");
